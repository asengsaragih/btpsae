jQuery(document).ready(function($) {
   ...
   jQuery('.tp-banner').show().revolution(
    ...
    $('#countdown').countdown({until: new Date(2018, 3-1, 3)}); // enter event day 
	...
	var owl = $("#price-carousel");
	  ...
	  //OWLCAROUSEL PRICE TABLE CAROUSEL 2
	var owl = $("#price-carousel2");
	...
	var latlng = new google.maps.LatLng(-6.9739024, 107.627451);
	...
	var image = new google.maps.MarkerImage('assets/web/img/logo-h-53.png',
	...
	var marker1 = new google.maps.Marker({
		position: new google.maps.LatLng(-6.9739024, 107.627451), 
		map: map,		
	...
	var infowindow1 = new google.maps.InfoWindow({  
		content:  createInfo('Telkom University', 'Jl. Telekomunikasi Terusan Buah Batu, 40257,<br />Bandung , Indonesia,<br />+62 (22) 7564 108<br /><br />')
	}); 
